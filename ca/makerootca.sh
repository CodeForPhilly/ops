...
ROOT_CA_LOCALITY="Philadelphia"
ROOT_CA_ORGANIZATION_NAME="IT Department"
ROOT_CA_ORGANIZATION_UNIT_NAME="Support"
ROOT_CA_COMMON_NAME="Root CA"
ROOT_CA_EMAIL_ADDRESS="someadmin@somecompany.com"
